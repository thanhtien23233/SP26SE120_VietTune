...
import type { ModerationQueueStatusMeta } from "@/pages/moderation/queueStatusMeta";
import { ModerationStatus } from "@/types";
import { SearchableDropdown } from "@/components/features/moderation/SearchableDropdown";
                            ...
                            return (
                                <div
                                    ...
                                    onKeyDown={(e) => {
                                        ...
                                        let nextIndex = idx;
                                        if (e.key === "ArrowDown") nextIndex = Math.min(visibleQueueItems.length - 1, idx + 1);
                                ...
                                >
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1.5 mb-1">
                                        <h3 className="text-sm font-semibold text-neutral-900 line-clamp-2 pr-1">{rowTitle}</h3>
