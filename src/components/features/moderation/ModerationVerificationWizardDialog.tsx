...
import { buildRecordingForModerationWizard } from "@/pages/moderation/buildRecordingForModerationWizard";
import { resolveCulturalContextForDisplay } from "@/pages/moderation/resolveReferenceDisplayStrings";
        ...
        return (
            <div className="space-y-2">
                ...
                <p className="text-xs text-neutral-400">
                    MediaType: {item.mediaType || "Không xác định"} | YouTube URL: {item.youtubeUrl ? "Có" : "Không"} | VideoData:{" "}
            ...
            >
                ...
                <div className="overflow-y-auto p-6 max-h-[80vh]">
                    <div className="space-y-6">
                        {item.moderation?.assignBlockedByRbac && (
                            ...
                            >
                                ...
                                <p className="mt-1 text-amber-900/90">
                                    Máy chủ từ chối gán chuyên gia (403 — quyền Admin API có thể chưa bật). Bạn vẫn có thể làm việc trên máy
                                    này; trạng thái claim có thể không khớp với máy chủ hoặc phiên khác.
                                </p>
                            </div>
                        )}
                        <div className="rounded-2xl border border-neutral-200/80 shadow-md p-4 sm:p-5" style={{ backgroundColor: "#FFFCF5" }}>
                            <label
                        ...
                        >
                            <h3 className="text-lg font-semibold text-neutral-900 mb-4" id={`verification-media-heading-${submissionId}`}>
                    Bản thu
                            </h3>
                        ...
                        {step1CulturalContext && (
                            ...
                            >
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    {step1CulturalContext.instruments && step1CulturalContext.instruments.length > 0 && (
                                        <div>
                        ...
                        >
                            <div className="mb-4">
                                <h3 id={`verification-step-heading-${currentStep}`} className="text-base font-semibold text-neutral-900 mb-2">
                                    {stepNames[currentStep - 1]}
                                </h3>
                                <p id={`verification-step-description-${currentStep}`} className="text-neutral-700 mb-4">
                                    {stepDescriptions[currentStep - 1]}
                                </p>
                                <div className="flex items-center gap-2 mb-6" aria-label={`Tiến độ kiểm duyệt: bước ${currentStep} trong 3`}>
                                    {[1, 2, 3].map((step) => (
                                ...
                                {!isCurrentStepValid && (
                                    <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg" role="alert">
                                        <p className="text-sm text-red-600 font-medium">Vui lòng hoàn thành tất cả các yêu cầu bắt buộc</p>
                                    </div>
                                )}
                            </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(1, "infoComplete", e.target.checked)}
                                        ...
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(1, "infoAccurate", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                        ...
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(1, "formatCorrect", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(2, "culturalValue", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                        ...
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(2, "authenticity", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                                Tính xác thực: Bản thu là bản gốc, không phải bản sao chép hoặc chỉnh sửa không được phép
                                            </span>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <input
                                            ...
                                            />
                                            <span className="text-neutral-700">
                                                Độ chính xác: Thông tin về dân tộc, thể loại, phong cách phù hợp với nội dung bản thu
                                            </span>
                                        </div>
                                    </div>
                                    <div className="mt-4">
                            ...
                            {currentStep === 3 && (
                                <div className="space-y-4">
                                    <h3 className="font-semibold text-neutral-800 mb-3">
                                        Đối chiếu và phê duyệt cuối cùng <span className="text-sm text-neutral-500">(Bắt buộc)</span>
                                    </h3>
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(3, "crossChecked", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                                Đã đối chiếu: Đã kiểm tra và đối chiếu với các nguồn tài liệu, cơ sở dữ liệu liên quan
                                            </span>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(3, "sourcesVerified", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                        ...
                                        <div className="flex items-start gap-3">
                                            <input
                                                ...
                                                onChange={(e) => onUpdateVerificationForm(3, "finalApproval", e.target.checked)}
                                                className="mt-1 h-5 w-5 flex-shrink-0 rounded border-neutral-300 accent-primary-600 hover:accent-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 cursor-pointer"
                                            />
                                            <span className="text-neutral-700">
                                                Xác nhận phê duyệt: Tôi xác nhận đã hoàn thành tất cả các bước kiểm tra và đồng ý phê duyệt bản
                                                thu này
                                            </span>
                                        </div>
                                    </div>
